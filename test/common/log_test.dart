...
void main() {
  ...
  test('records entries regardless of the print level', () {
    // Log.level defaults to `none`, which suppresses printing entirely. The
    // in-app log has to record anyway, otherwise it is empty exactly when
    // someone needs it.
  ...
  test('entries render with level, tag and message', () {
  ...
  test('new entries are broadcast to listeners', () async {
    final seen = <LogEntry>[];
